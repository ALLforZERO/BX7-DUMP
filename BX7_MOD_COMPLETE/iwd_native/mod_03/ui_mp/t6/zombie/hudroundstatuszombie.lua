...
LUI.createMenu.RoundStatus = function (LocalClientIndex)
	...
	RoundStatusWidget.roundText:setLeftRight(true, false, CoD.RoundStatus.LeftOffset, CoD.RoundStatus.LeftOffset + CoD.RoundStatus.ChalkSize)
	...
	RoundStatusWidget.visible = false
...
CoD.RoundStatus.UpdateSpecialRound = function (RoundStatusWidget, ClientInstance)
	if ClientInstance.newValue == 1 then
		if not RoundStatusWidget.specialRoundIcon then
			...
			RoundStatusWidget.specialRoundIcon:setLeftRight(true, false, CoD.RoundStatus.LeftOffset, CoD.RoundStatus.LeftOffset + CoD.RoundStatus.SpecialRoundIconSize)
