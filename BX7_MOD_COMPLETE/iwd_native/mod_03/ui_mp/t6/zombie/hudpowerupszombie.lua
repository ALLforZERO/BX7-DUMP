CoD.PowerUps = {}
CoD.PowerUps.IconSize = 40
CoD.PowerUps.UpgradeIconSize = 28
...
LUI.createMenu.PowerUpsArea = function (LocalClientIndex)
	...
	local f1_local2 = CoD.PowerUps.IconSize + CoD.PowerUps.UpgradeIconSize + 44+32
	local Widget = nil
	...
	for ClientFieldIndex = 1, #CoD.PowerUps.ClientFieldNames, 1 do
		...
		powerUpIcon:setTopBottom(false, true, -CoD.PowerUps.IconSize - 44 - 48, -44-48)
		...
		upgradePowerUpIcon:setTopBottom(true, false, -24, CoD.PowerUps.UpgradeIconSize-24)
