...
if CoD.isZombie == true then
	...
	require("T6.Zombie.WunderfizzMenu")
	require("T6.Zombie.PackAPunchMenu")
else
	require("T6.VcsMenu")
...
function HUD_FirstSnapshot_Zombie(HUDWidget, ClientInstance)
	...
	-- Register Wunderfizz listener on the active HUDWidget
    if CoD.WunderfizzMenu and CoD.WunderfizzMenu.Register then
        CoD.WunderfizzMenu.Register(Widget, ClientInstance.controller)
    end
	
	-- Register Pack-a-Punch listener
    if CoD.PackAPunchMenu and CoD.PackAPunchMenu.Register then
    CoD.PackAPunchMenu.Register(Widget, ClientInstance.controller)
    end
end
